...
fn main() {
    ...
    let sum = sum_of_possible_games(&input);
...
mod test {
    ...
    #[test]
    fn test_game_is_possible_returns_true_for_valid_game() {
        let game = Game {
            id: 0,
            max_red: 4,
            max_green: 2,
        ...
        assert!(game_is_possible(&game));
    }

    #[test]
    fn test_game_is_possible_returns_false_for_invalid_game() {
        let game = Game {
            id: 0,
            max_red: 20,
            max_green: 13,
